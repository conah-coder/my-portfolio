  ...
  <header className="bg-red-600">
   <div className="container mx-auto flex justify-between">
    ...
    <div className="inline-flex py-3 px-3 my-3">
     <SocialIcon url="https://twitter.com/EhiO__?s=03" className="mr-4" target="_blank" fgColor="#fff" style={{height:35, width:35}}/>
     <SocialIcon url="https://www.linkedin.com/in/comfort-onah-363a9a159" className="mr-4" target="_blank" fgColor="#fff" style={{height:35, width:35}}/>
     <SocialIcon url="https://www.instagram.com/conah__?r=nametag" className="mr-4" target="_blank" fgColor="#fff" style={{height:35, width:35}}/>
     <SocialIcon url="https://github.com/conah-coder" className="mr-4" target="_blank" fgColor="#fff" style={{height:35, width:35}}/>
